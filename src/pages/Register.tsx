...
export function Register() {
	return (
		<div className="flex min-h-screen items-center justify-center">
			<div className="to-main-bg relative mx-[10px] my-[120px] flex min-h-[520px] w-full max-w-[380px] rounded-lg bg-linear-to-br from-[#12612f] via-[#240051] shadow-[0_0_20px_#ffffff]/10 transition-[max-width] duration-500 md:max-w-[720px]">
